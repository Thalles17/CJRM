...
charactersCopy.sort((item1 ,item2) => item2.id - item1.id)
...
const primaryItemBigger50 = randomNumbers.find((item) => item > 5)
//find é um método que retorna o primeiro item do array que corresponda a função de teste que a gente passar até retornar um valor thurthing (valor true)

console.log(primaryItemBigger50)
/*
  05
...
const copyPeople = people.map(item => item).sort()
console.log(copyPeople.reverse())//reverse reverte ordem dos itens de um array
/*
  06
...
ingredients.reduce((acc, item,index, array) => {
