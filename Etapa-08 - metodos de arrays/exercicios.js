...
const numbersOdd = randomNumbers.filter(numbers => numbers % 2 === 1)
...
const numbers = [5, 7, 3]
const squaradNumbers = numbers.map(number => number ** 2)
console.log(squaradNumbers)
/*
  04
...
const nameGames = cart.reduce((acc, game)=> {
