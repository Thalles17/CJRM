...
setTimeout(()=> {`Função de callback passada! Còdigo assincrono`}, 2000)
...
const x = callback => {
 ...
 x(logGreeting)//callback é uma função passada como argumento para outra função
...
const numberOddFive = num => num < 5
const lesserThanFive = numbers.filter(numberOddFive)
