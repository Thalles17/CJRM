...
function myAge(){
    let age = 30//variavel local
    console.log(age)
}
myAge()
//console.log(age)
//console.log(age)//variavel declarada no escopo global que não existe
...
const car = {
    ...
    getColorsMessage (){
        ...
        //     console.log(color)
        // })
        let lastItem = this.colors[this.colors.lengh -1]
        return (`${this.name} está disponível nas cores ${this.colors.join(', ').replace(lastItem, `e ${lastItem}`)}`)
    }
