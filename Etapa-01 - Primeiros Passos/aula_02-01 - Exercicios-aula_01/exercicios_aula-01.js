...
- Declare uma marcação HTML básica nele; //Feito
- Modifique a linguagem para português do Brasil; //feito
- Remova as meta tags desnecessárias; //feito
- Modifique o title para "Exercício 01";//Feito
- E linke este arquivo, app.js, antes do fechamento da tag body. //Feito
*/

/*
02 - Inicie o seu servidor local e abra o console do browser.//Feito
*/
