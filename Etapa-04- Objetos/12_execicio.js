...
const best2019Movies = [
  ...
  const generateMovieMenssage = movie => {
    menssage += `
    - ${movie.title}, dirigido por ${movie.directedBy}`
  }

  best2019Movies.forEach(generateMovieMenssage)
  ...
  */
  ...
  firstNumberArredonded = Math.ceil(firstNumber)
  console.log(firstNumberArredonded)
  /*
    05
  ...
  */
     ...
     console.log(Math.round(numberRandom * 10)) 